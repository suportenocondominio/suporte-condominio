...
function AppHome({ user, setUser }) {
  ...
  const services = [
    { icon: <Laptop size={24} />, title: 'Computadores', desc: 'Notebook lento e manutenção.' },
    { icon: <Wifi size={24} />, title: 'Wi-Fi', desc: 'Internet e roteadores.' },
    { icon: <Camera size={24} />, title: 'Câmeras', desc: 'Instalação e configuração.' },
    { icon: <Plug size={24} />, title: 'Elétrica', desc: 'Pequenos reparos.' },
    { icon: <ShieldCheck size={24} />, title: 'Segurança', desc: 'Proteção digital.' },
    { icon: <HardDrive size={24} />, title: 'Backup', desc: 'SSD e upgrades.' },
  ]
